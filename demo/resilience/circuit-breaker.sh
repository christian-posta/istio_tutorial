...
run "istioctl replace -f $(relative istio/recommendation-destinationrule-cb.yml) -n tutorial"
...
run "istioctl replace -f $(relative istio/recommendation-service-retry.yml) -n tutorial"
